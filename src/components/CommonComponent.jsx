            ...
            <div className="common flex justify-center mt-5">
                <div className="container w-full shadow-lg grid md:grid-flow-col p-20 ">
                    <div className="container_info grid ">
                        ...
                        <div className="button flex flex-start"><button type="button" className=" text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Buy Now</button></div>
                    </div>
